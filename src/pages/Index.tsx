              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-gray-600 mt-2">Selamat datang di sistem POS Apotek Mini</p>
                  </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                  <StatsCard
                    ...
                    value={`Rp ${branchStats.totalSales.toLocaleString()}`}
                  ...
                  <StatsCard
                    ...
                    value={branchStats.totalTransactions.toString()}
                  ...
                  <StatsCard
                    title="Total Produk"
                    value={branchStats.totalProducts.toString()}
